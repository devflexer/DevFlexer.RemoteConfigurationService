...
using DevFlexer.RemoteConfigurationService.Hosting.Providers;
using DevFlexer.RemoteConfigurationService.Hosting.Publishers;
using Microsoft.Extensions.Logging;
using NSubstitute;
using Xunit;

namespace DevFlexer.RemoteConfigurationService.Test
{
    public class PublishTests
    {
        private readonly ILogger<Hosting.RemoteConfigurationService> _logger;
